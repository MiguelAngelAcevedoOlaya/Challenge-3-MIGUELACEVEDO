...
class Rectangle:
    ...
    def __init__(self, method):
        if method == 1:
            ...
            points = [(int(input("Enter the x_1 : ")),int(input("Enter the y_1 : "))), (int(input("Enter the x_2 : ")),int(input("Enter the y_2 : "))), (int(input("Enter the x_3 : ")),int(input("Enter the y_3 : "))), (int(input("Enter the x_4 : ")),int(input("Enter the y_4 : ")))]
